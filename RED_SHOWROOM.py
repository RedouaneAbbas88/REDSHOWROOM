...
# ---------------------------------------------------
# 🔹 Onglets avec état conservé
# ---------------------------------------------------
if "active_tab" not in st.session_state:
    st.session_state.active_tab = 0  # Par défaut on ouvre le 1er onglet
...
with tabs[0]:
    if st.session_state.active_tab == 0:
        ...
        with st.form("form_stock"):
            ...
            if st.form_submit_button("Ajouter au stock", on_click=lambda: set_active_tab(0)):
...
with tabs[1]:
    if st.session_state.active_tab == 1:
        ...
        with st.form("form_vente_multi"):
            ...
            if st.form_submit_button("Ajouter au panier", on_click=lambda: set_active_tab(1)):
        ...
        if st.session_state.panier:
            ...
            for i, item in enumerate(st.session_state.panier):
                ...
                with col3:
                    if st.button("❌ Supprimer", key=f"del_{i}", on_click=lambda: set_active_tab(1)):
            ...
            if st.button("Enregistrer la vente", key="enregistrer_vente", on_click=lambda: set_active_tab(1)):
